...
export function Footer() {
  return (
    <footer className="w-full bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border-t border-white/30 dark:border-gray-700/60 shadow-lg mt-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 sm:px-8 py-6 gap-4">
        <div className="text-gray-700 dark:text-gray-300 text-sm font-medium">
          &copy; {new Date().getFullYear()} Pranith. All rights reserved.
        </div>
