			...
			<section className="flex-1 flex flex-col md:flex-row items-center justify-center px-4 py-16 gap-12">
				...
				<div className="flex-1 flex flex-col items-start justify-center max-w-xl">
					...
					<p className="text-base sm:text-lg text-gray-600 mb-8">
						I&apos;m a freelance UX designer based in Toronto, Canada. I&apos;ve
						worked with startups and established companies. I&apos;m passionate
						about my work.
					</p>
					<button className="bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-lg text-lg shadow-lg transition-all mb-10">
						Hire me
					</button>
				...
				<div className="flex-1 flex flex-col items-center justify-center">
					<div className="rounded-[2.5rem] border-8 border-blue-700 shadow-2xl p-2 bg-white/60">
						<ZoomableImage
							src="/pranith.jpg"
							alt="Pranith photo"
							width={288}
							height={360}
							className="w-72 h-80 object-cover rounded-[2rem]"
						/>
					</div>
